...
/// every platform without pulling in the Darwin-specific carrick-host crate.
/// Callers on macOS pass the value directly (no cast needed — `mach_port_t`
