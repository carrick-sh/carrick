...
const X8664_VDSO_CODE: &[u8] = &[
    ...
    0xc0, 0xc3,
    // __vdso_gettimeofday (@0xa2) + __vdso_time (@0x106) fast paths, assembled
    // from tools/vdso_x86_gtod.S (NOT hand-encoded). Both mirror
    // __vdso_clock_gettime's realtime math (total_ns = tsc*1e9/freq +
    // REALTIME_OFF_NS): gettimeofday writes sec/usec to the timeval, time writes
    // sec to the time_t. freq==0 falls back to the syscall.
    ,
];
...
// gettimeofday is now a 100-byte fast path (was an 8-byte syscall stub), so time
// moves from 0xaa to 0xa2 + 100.
const X8664_SYM_TIME: u64 = 0x106;
