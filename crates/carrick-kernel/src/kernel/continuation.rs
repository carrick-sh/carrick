...
pub struct ContinuationState {
    ...
    pub(crate) authority: ContinuationAuthority,
    pub(crate) deadline: Option<Instant>,
    pub(crate) outputs: Vec<GuestOutputRange>,
    pub(crate) signal_masks: SignalMaskContinuationState,
    pub(crate) detail: ContinuationDetail,
    pub(crate) resource_generation: u64,
    pub(crate) private_futex: Option<FutexSource>,
    pub(crate) producer_completion: Arc<Mutex<Option<DispatchOutcome>>>,
