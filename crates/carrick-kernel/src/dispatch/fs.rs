...
syscall_table! {
    ...
    nr::IO_SETUP => io_setup,
    nr::IO_DESTROY => io_destroy,
    nr::IO_SUBMIT => io_submit,
    nr::IO_CANCEL => io_cancel,
    nr::IO_GETEVENTS => io_getevents,
    nr::GETCWD => getcwd,
    nr::DUP => dup,
    nr::DUP3 => dup3,
    nr::CARRICK_PRIVATE_X86_DUP2 => dup2,
    nr::CARRICK_PRIVATE_X86_STAT => x86_stat,
    nr::CARRICK_PRIVATE_X86_FSTAT => x86_fstat,
    nr::CARRICK_PRIVATE_X86_LSTAT => x86_lstat,
    nr::CARRICK_PRIVATE_X86_NEWFSTATAT => x86_newfstatat,
    nr::INOTIFY_INIT1 => inotify_init1,
    nr::INOTIFY_ADD_WATCH => inotify_add_watch,
    nr::INOTIFY_RM_WATCH => inotify_rm_watch,
    nr::IOCTL => ioctl,
    nr::FLOCK => flock,
    nr::MKNODAT => mknodat,
    ...
    nr::FCHMODAT2 => fchmodat2, // validates the flags arg (nr 53 ignores it)
    ...
    nr::FANOTIFY_INIT => fanotify_init,
    nr::FANOTIFY_MARK => fanotify_mark,
    nr::NAME_TO_HANDLE_AT => name_to_handle_at,
    nr::SYNCFS => syncfs,
    nr::SYNC_FILE_RANGE => sync_file_range,
    nr::CACHESTAT => cachestat,
    nr::RENAMEAT2 => renameat2,
    nr::MEMFD_CREATE => memfd_create,
    nr::MEMFD_SECRET => memfd_secret,
    ...
    nr::OPENAT2 => openat2,
    nr::FACCESSAT2 => faccessat2,
    nr::SETXATTR => sys_setxattr_path,
    nr::LSETXATTR => sys_lsetxattr_path,
    nr::FSETXATTR => sys_setxattr_fd,
    nr::GETXATTR => sys_getxattr_path,
    nr::LGETXATTR => sys_lgetxattr_path,
    nr::FGETXATTR => sys_getxattr_fd,
    nr::LISTXATTR => sys_listxattr_path,
    nr::LLISTXATTR => sys_llistxattr_path,
    nr::FLISTXATTR => sys_listxattr_fd,
    nr::REMOVEXATTR => sys_removexattr_path,
    nr::LREMOVEXATTR => sys_lremovexattr_path,
    nr::FREMOVEXATTR => sys_removexattr_fd,
    nr::STATFS => sys_statfs,
    nr::FSTATFS => sys_fstatfs,
    nr::TRUNCATE => sys_truncate,
    nr::TEE => tee,
}
