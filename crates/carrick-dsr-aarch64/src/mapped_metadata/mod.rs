...
pub use wire::{
    BINDING_RECORD_V3_SIZE, BINDING_RELOCATION_RECORD_V3_SIZE, BINDING_TARGET_INDEX_RECORD_V3_SIZE,
    BLOCK_GUEST_INDEX_RECORD_V3_SIZE, EDGE_GROUP_RECORD_V3_SIZE, EDGE_MEMBER_RECORD_V3_SIZE,
    GUEST_PC_INDEX_RECORD_V3_SIZE, GUEST_RANGE_RECORD_V3_SIZE, HEADER_SIZE_V3,
