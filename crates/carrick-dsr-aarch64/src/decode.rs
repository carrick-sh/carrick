...
pub fn exclusive_shape(op: Op) -> Option<ExclusiveShape> {
    match op {
...
pub fn decoded_operands_mention_x18(word: u32, pc: GuestVa) -> bool {
    decoded_operands_mention_gpr(word, pc, 18)
}

pub fn decoded_operands_mention_x28(word: u32, pc: GuestVa) -> bool {
...
pub fn decoded_operands_mention_gpr(word: u32, pc: GuestVa, index: u32) -> bool {
...
pub fn copied_instruction_mentions_gpr(word: u32, pc: GuestVa, index: u32) -> Option<bool> {
    if word == CHKFEAT_X16 {
...
pub fn classify(word: u32, pc: GuestVa) -> Result<InstAction, DsrError> {
...
mod tests {
    use super::*;
    use crate::types::{MemoryBase, MemoryClass, MemoryVirtualization, MemoryWriteback};
