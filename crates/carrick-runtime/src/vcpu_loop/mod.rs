...
pub(crate) const LIVENESS_POLL: std::time::Duration = std::time::Duration::from_millis(250);
...
/// job exists.
pub(crate) const LIVENESS_CONFIRM: std::time::Duration = std::time::Duration::from_secs(2);
