//! Shim: the Darwin commpage/mach-timebase counter planning moved verbatim
//! to `carrick_dsr_aarch64::counter` as part of the staged native-backend
//! extraction (see
//! docs/superpowers/specs/2026-07-17-native-backend-portability-seams-design.md);
//! re-exported so existing `super::counter::*` call paths resolve unchanged.
...
pub(in crate::native_darwin) use carrick_dsr_aarch64::counter::*;
