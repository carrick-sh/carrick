...
use carrick_abi::{
    LINUX_RLIM_INFINITY, LinuxEpollEvents, LinuxGuestAbi, LinuxResource, LinuxRlimit, LinuxSiginfo,
    NsGid, NsUid, SigSet,
};
...
pub struct Thread {
    ...
    pub(super) signal_state: Mutex<ThreadSignalState>,
...
impl Thread {
    ...
    pub(super) fn publish_signal_state(&self, state: &ThreadSignalState) {
        self.signal_pending_hint
