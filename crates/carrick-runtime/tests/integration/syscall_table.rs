...
fn dispatch_declares_no_abi_constants() {
    ...
    let sources = [
        include_str!("../../../carrick-kernel/src/dispatch/mod.rs"),
        include_str!("../../../carrick-kernel/src/dispatch/fs.rs"),
        include_str!("../../../carrick-kernel/src/dispatch/mem.rs"),
        include_str!("../../../carrick-kernel/src/dispatch/signal.rs"),
        include_str!("../../../carrick-kernel/src/dispatch/creds.rs"),
        include_str!("../../../carrick-kernel/src/dispatch/net.rs"),
        include_str!("../../../carrick-kernel/src/dispatch/time.rs"),
        include_str!("../../../carrick-kernel/src/dispatch/proc.rs"),
    ];
    for src in sources {
