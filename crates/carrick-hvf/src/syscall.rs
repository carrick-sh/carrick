...
const AARCH64_SYSCALLS: &[Syscall] = &[
    ...
    syscall(125, "sched_get_priority_max", "sched", SupportLevel::Deferred),
    syscall(126, "sched_get_priority_min", "sched", SupportLevel::Deferred),
    syscall(127, "sched_rr_get_interval", "sched", SupportLevel::Deferred),
    ...
    syscall(186, "msgget", "ipc", SupportLevel::Deferred),
    syscall(187, "msgctl", "ipc", SupportLevel::Deferred),
    syscall(188, "msgrcv", "ipc", SupportLevel::Deferred),
    syscall(189, "msgsnd", "ipc", SupportLevel::Deferred),
    syscall(190, "semget", "ipc", SupportLevel::Deferred),
    syscall(191, "semctl", "ipc", SupportLevel::Deferred),
    syscall(192, "semtimedop", "ipc", SupportLevel::Deferred),
    syscall(193, "semop", "ipc", SupportLevel::Deferred),
    syscall(194, "shmget", "ipc", SupportLevel::Deferred),
    syscall(195, "shmctl", "ipc", SupportLevel::Deferred),
    syscall(196, "shmat", "ipc", SupportLevel::Deferred),
    syscall(197, "shmdt", "ipc", SupportLevel::Deferred),
    ...
    syscall(407, "clock_nanosleep_time64", "time", SupportLevel::Deferred),
    ...
    syscall(421, "rt_sigtimedwait_time64", "signal", SupportLevel::Deferred),
    ...
    syscall(444, "landlock_create_ruleset", "process", SupportLevel::Deferred),
    syscall(445, "landlock_add_rule", "process", SupportLevel::Deferred),
    syscall(446, "landlock_restrict_self", "process", SupportLevel::Deferred),
