...
pub use foreign_mm::{
    ...
    ForeignCowInvalidationIdentity, ForeignCowLiveInventoryReceipt, ForeignCowReceipt,
    ForeignMmBinding, ForeignMmEndpoint, ForeignMmId, ForeignMmInvalidator, ForeignMmInvocation,
