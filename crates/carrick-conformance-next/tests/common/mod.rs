...
/// Exact materialized list of 157 sorted unique probe names for generic shard 0.
///
...
/// Hard-asserted to have exactly 156 sorted unique names.
...
fn special_policy_names_are_unique_in_the_generic_shard_union() {
    ...
    assert_eq!(union.len(), 470, "generic shard union must remain complete");
