...
- **Kernel semantics inner loop** — `crates/carrick-kernel-example` drives the public kernel API with scripted Linux processes and threads. Use `just test-kernel`; see its [README](crates/carrick-kernel-example/README.md) and [conformance testing](docs/conformance-testing.md#kernel-semantics-suite).
