...
### Roster re-ranked 2026-08-06 — E0 MEASURED (Task 4)

E0 is done; the table above is superseded by the measured ranking in
[`2026-08-06-build-lane-amplification-ledger.md`](../../perf-results/2026-08-06-build-lane-amplification-ledger.md)
§11. Headline: **fault-ownership CONFIRMED at HEAD** (host-other zfod
63.2559%/63.2966% vs the 08-03 pair 63.2115%/62.7395%); neither §4
invalidation condition fired (`carrick-only` = 42.2% of measured kernel CPU —
large, not dominant; no single-host-call concentration). Measured order:

| rank | entry | measured basis | movement |
|---|---|---|---|
