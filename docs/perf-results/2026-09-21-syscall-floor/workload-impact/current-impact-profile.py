...
binary=Path('/Volumes/CaseSensitive/carrick/target/syscall-floor/carrick-fstat-allocation')
for name,n in [('node-app',20),('go-build-cold',5),('python-os',3)]:
 image,body,_=screen.WORK[name];label='current-impact-'+name;rid='floor-'+label
