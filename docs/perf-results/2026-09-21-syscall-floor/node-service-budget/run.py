...
out=root/'target/lease-cost/node-service-budget'
...
rid='node-service-budget-20260922-1'
body='set -eu; for n in 1 2 3 4 5; do /opt/node-src/v24/out/Release/node /opt/nodejs-conformance/fixtures/app-smoke.js; done; echo POPULATION_DONE'
