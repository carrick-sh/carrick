...
fn main() {
    unsafe {
        ...
        report!(
            ...
            handler_seq_two_before_extra_syscall = seq_hits_before_syscall == 2,
            handler_seq_sig_unblocked = !seq_sig_blocked_after_first_wait,
            handler_seq_sig_not_pending = !seq_sig_pending_after_first_wait,
            handler_seq_two_hits = seq_hits == 2,
            handler_seq_parent_first = seq_first_fd == seq_parent_fd,
            handler_seq_child_not_first = seq_first_fd != seq_sub_fd,
