...
const AARCH64_SYSCALLS: &[Syscall] = &[
    ...
    syscall(95, "waitid", "process", SupportLevel::Planned),
    ...
    syscall(198, "socket", "net", SupportLevel::Planned),
    syscall(199, "socketpair", "net", SupportLevel::Planned),
    syscall(200, "bind", "net", SupportLevel::Planned),
    syscall(201, "listen", "net", SupportLevel::Planned),
    syscall(202, "accept", "net", SupportLevel::Planned),
    syscall(203, "connect", "net", SupportLevel::Planned),
    syscall(204, "getsockname", "net", SupportLevel::Planned),
    syscall(205, "getpeername", "net", SupportLevel::Planned),
    syscall(206, "sendto", "net", SupportLevel::Planned),
    syscall(207, "recvfrom", "net", SupportLevel::Planned),
    syscall(208, "setsockopt", "net", SupportLevel::Planned),
    syscall(209, "getsockopt", "net", SupportLevel::Planned),
    syscall(210, "shutdown", "net", SupportLevel::Planned),
    syscall(211, "sendmsg", "net", SupportLevel::Planned),
    ...
    syscall(242, "accept4", "net", SupportLevel::Planned),
    syscall(260, "wait4", "process", SupportLevel::Planned),
